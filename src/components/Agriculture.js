...
import { AgricultureSmall } from "./AgricultureSmall";
          ...
          <div className="spBody">
            <div className="width-70">
              ...
              <p className="paragraph">
                ...
                and economies. We use <b>planting methods</b>
            ...
            <div className="width-70">
              ...
              <p className="paragraph">
                ...
                threat to our future survival. According to soil scientists, at
                current rates of soil destruction (i.e. decarbonization,
                erosion, desertification, chemical pollution), within{" "}
                <b>50 years</b> we will not only suffer serious damage to public
                health due to a qualitatively degraded food supply characterized
                by diminished nutrition and loss of important trace minerals,
                but we will literally no longer have enough arable topsoil to
                feed ourselves. Without protecting and regenerating the soil on
                our 4 billion acres of cultivated farmland, 8 billion acres of
                pastureland, and 10 billion acres of forest land, it will be
                impossible to feed the world, keep global warming below 2
                degrees Celsius, or halt the loss of biodiversity.
                <br />
                <br />
                <b>
