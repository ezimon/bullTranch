          ...
          <div className="shadowImg">
            ...
            <div className="Cont">
              ...
              <p className="paragraph subP">
                ...
                soil, hydroponics relies on supplying nutrition directly to the
                plants by using nutrient-rich water.
              </p>
              <br />
          ...
          <div className="spBody">
            <div className="width-70">
              ...
              <p className="paragraph">
                ...
                <br />
                Plants also need light, water, carbon dioxide and oxygen at the
                root zone. In hydroponics, plants are grown in an inert medium
                such as rocks or coco coir fiber, and they are fed a solution
                containing a perfected mix of primary, secondary and
                micro-nutrients.
                <br />
                <br />
                Almost <b>any kind of plant can be grown hydroponically</b>,
                including veggies, herbs, fruits and flowers. Hydroponics is
                widely used by farmers and growers throughout California. You
                might have noticed hydroponic tomatoes or ‘living’ lettuce in
                the refrigerated section at your grocery store. You might also
                ...
                controlled in a greenhouse. Because their roots do not need to
                reach for nutrients, the plants can be grown closer together.
                The plants grown are significantly larger because of so many
                available nutrients and not having to waste time growing
                extensive root systems. This makes the yields bigger. The
                nutrient solution also keeps the same amount of nutrients
                available all the time, whereas soil tends to “wear out” as the
                ...
                beginning to switch over to hydroponics for all of these
                reasons. The concern about water use is also a BIG reason
                hydroponics is becoming more popular - it significantly{" "}
            ...
            <div className="width-70">
              ...
              <p className="paragraph">
                ...
                normally be impossible. In poor soil for example, or in rocky
                areas, balconies and rooftops. With the use of artificial
                lighting it is even possible to successfully garden in a spare
                room or garage.
                <br />
                Hydroponics will produce a much higher yield than growing in
                soil, so if you want to max the production of your garden,
                hydroponics is a great way to do it! Hydroponics is also great
                because:
                <ul>
                  <br />
                  <li>
                  ...
                  <br />
                  <li>
                    Hydroponically grown fruit and veggies have increased flavor
                    and texture
                  </li>
                  <br />
                  <li>
                  ...
                  <br />
                  <li>
                    Plants do not need to compete for nutrients, thus more can
